...
public class UserLocationAdapter extends RecyclerView.Adapter
{
    ...
    public UserLocationAdapter(Context context, List<modelItem> students, RecyclerView recyclerView, int layout, int mode)
    {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        if (Utils.global.mapData.size()>0)
                        {
                          ...
                          // ServiceInfo.Instance.DataFromoneTotwo();
                            ...
                            {
                                Utils.userLocationRequest(mcontext,Utils.global.mapData.get("id").toString(),"1");
                            }
